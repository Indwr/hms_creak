            ...
            <div class="topaleart" style="display:none">
                <div class="slidealert">
                    <div class="alert alert-dismissible topaleart-inside">
                        <p class="palert">Alert! You are using unregistered version of Dr Storks. Please <a  href="#" class="purchasemodal">click here</a> to register your purchase code for Dr Stocks.</p>
                    </div>
                </div>
            </div>
            <?php
